                            ...
                            <Row>
                                <div className="infoBlock">
                                    ...
                                    <div> Redesigned the Salesforce architecture to facilitate easier reporting.
                                        ...
                                        Designed and implemented recommendation algorithm to facilitate job matching.
                                        Helped position Baltimore Corps as a thought leader among data driven nonprofits
                                        through publications and presentations.</div>
                                <br></br>
                                    <p> <strong>September 2015 - December 2015</strong></p>
                                    <p style={{color: "grey"}}><strong>Baltimore Green Currency Association, Database Administrator</strong></p>
                                    <div>
                            ...
                            <Row>
                                <div className="infoBlock">
                                    ...
                                    <div className="allSkills">
                                        ...
                                        <br></br>
                                        <div className="skillCategory">
                                            <p style={{color: "grey"}}><strong>Data Architecture</strong></p>
                                            <div className="skills">
                                                <div className="skill">
