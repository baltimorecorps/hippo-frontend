...
class Experience extends React.Component {
  state = {
    ...
    achievements: [
      {id: 0, description: 'My achievement is....', achievement_order: 0},
      {id: 1, description: 'My achievement is ...', achievement_order: 1},
    ],
    type: 'Work',
    //id: 0,
  };
        ...
        <Row>
          ...
          <Col xs md lg="8">
            <button
              ...
              {this.state.showHint ? (
                <p> Click plus sign to add new experience </p>
              ) : null}
            </button>
          </Col>
        </Row>
