...
class ExperienceUpdateForm extends React.Component {
    ...
    handleSubmit =(event)=>{
      ...
      this.props.func(this.props.exp_id, this.state.organization, this.state.title, this.state.date_start, this.state.date_end, this.state.achievements,
        this.state.type);
      alert(`handleSubmit`);
    }
    handleCancel=(event)=>{
              ...
              <div style={{ margin:"20px"}}>
                <Form onSubmit={this.handleSubmit}>
                  <Form.Field>
                     ...
                     <input placeholder='Organization Name' value={this.state.organization} name="organization" onChange={this.handleChange} />
                  </Form.Field>

                  <Form.Field>
                    <label>
                      <h3>Title: </h3>
                      <input placeholder='Title Name' value={this.state.title} name="title" onChange={this.handleChange} />
                    </label>
                  </Form.Field>
                  ...
                  <Form.Field>
                    <label>
                      ...
                      {this.state.achievements.map((achievement, idx) => 
                            <div key={idx} style={{display: "flex", direction: "row", alignItems: "center"}}>
                              <input width="50%"
                                  type="text"
